...
{
    /// <summary>
    /// Toolchain package for building Linux players from a macOS (x86_64) host.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class ToolchainMacOSX86_64 : SysrootPackage
    {
        /// <summary>
        /// UPM package name that contains the LLVM/Clang payload.
        /// </summary>
        private string _packageName => "com.unity.toolchain.macos-x86_64-linux";
        ...
        /// </remarks>
        private string _payloadVersion => "15.0.6_7f65c218fc819205138cf737569ebc9e8ae84f1fdbdffdc0c1c53376f455d63d-1";
        ...
        /// </summary>
        public ToolchainMacOSX86_64()
            : base()
        {
            _payloadDir = $"llvm-mac-x64/{_payloadVersion}";
