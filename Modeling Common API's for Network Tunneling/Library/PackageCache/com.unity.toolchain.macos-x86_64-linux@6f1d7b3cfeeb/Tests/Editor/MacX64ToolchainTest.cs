...
/// <summary>
/// EditMode tests for the MacOS x86_64 toolchain package.
/// </summary>
/// <remarks>
...
class MacX64ToolchainTest
{
    ...
    {
        Assert.NotNull(new ToolchainMacOSX86_64());
    }
    ...
    {
        var toolchainPackage = new ToolchainMacOSX86_64();
