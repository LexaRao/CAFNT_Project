# com.unity.toolchain.macos-x86_64-linux

The `com.unity.toolchain.macos-x86_64-linux` package provides a toolchain for building IL2CPP players targeting both Linux and Embedded Linux platforms on a MacOS 64-bit(x86_64) host. It depends on the following package:
